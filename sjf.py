...
# Shortest Job First (Preemptive) - also known as Shortest Remaining Time First (SRTF)
def sjf_preemptive(processes):
    ...
    while completed < n:
        ...
        if available_processes:
            ...
            # Process it for 1 time unit (preemptive)
            time += 1
...
if __name__ == "__main__":
    ...
    sjf_result = sjf_preemptive(processes)
    display_results(sjf_result, "Shortest Job First (Preemptive)")
